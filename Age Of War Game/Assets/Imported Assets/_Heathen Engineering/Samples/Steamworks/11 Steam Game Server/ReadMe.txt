The scenes included in this example demonstrate the minimal set up required to initalize a Steam Game Server.
You should select one of these scenes as your build index 0 and build a server build of the game. 
Once built you can run the app to see Steam Game Server initalize.
...
1) Initalize the Steam API
2) Configure the Steam Game Server Settings
3) Initalize your HLAPI's Network Manager or similar concept
